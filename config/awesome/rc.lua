...
beautiful.init("/home/finiks/.config/awesome/themes/default/theme.lua")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "I", "II", "III", "IV" }, s, layouts[1])
end
-- }}}
...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, nil },
...
-- {{{ Wibox
-- Create an empty bar
mystatusbar = awful.wibox({ position = "bottom", screen = 1, ontop = false, width = 1, height = 16, bg = "#000000" })
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "Print",   function () os.execute("shot &", false)                             end),
...
--client.connect_signal("property::urgent", function() os.execute("mplayer /home/finiks/temp/beep.wav &") end)
-- }}}
